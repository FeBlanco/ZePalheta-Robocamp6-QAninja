...
Update a Customer
    # Cliente Origem
    ${payload}=             Get Json            customers/zoro.json
    ...
    Set To Dictionary       ${payload}          name         Zoro Sola
    ...
    Should Be Equal         ${resp.json()['name']}           Zoro Sola



## robot -d ./logs tests\api\customers\put_customers.robot